...
# 
# コンピュータが格納したなまデータを要約するために**モデル**を使います。
# 
...
# ```{margin}
# パラメータ: モデルが学習を通じて自動的に調整する値です。
# ハイパーパラメータ: モデルの学習前に人間が設定する値です。例えば、学習率、正則化の強さ、エポック数、バッチサイズなどが挙げられます。
# ```
